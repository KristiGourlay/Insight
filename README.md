...
I attempted many different models. I vectorized with CountVectorizer and Tf-idf and modeled with Logistic Regression, RandomForest and MultinomialNB. I attemped more advanced models like Doc2Vec and BERT, and attempted to Catboost with a dataset with sentiment analysis features and polarity Doc2Vec scores (concatenated with Tfidf matrix). 
